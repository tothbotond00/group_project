...
class group_table extends \table_sql
{
    ...
    public function col_actions($group){
        ...
        $usersurl = new \moodle_url('/mod/groupproject/modify_group.php', $addusers);
        ...
        // Modify
        $modifyparams = ['id' => $context->instanceid, 'groupid' => $group->id];
        $modifyurl = new \moodle_url('/mod/groupproject/modify_group.php', $modifyparams);
        ...
        // Delete.
        $deleteparams = ['id' => $context->instanceid, 'groupid' => $group->id];
        $deleteurl = new \moodle_url('/mod/groupproject/delete_group.php', $deleteparams);
